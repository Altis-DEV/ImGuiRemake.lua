...
function Row.new(
    ...
    --------------------------------------------------------
    -- Layout mode fixed when created
    --------------------------------------------------------
...
function Row:_MeasureSlotHeight(slot)
