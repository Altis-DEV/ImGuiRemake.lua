...
SliderTab:Paragraph({
    ...
    Text = "Tests negative values, decimal values, Format, SetValue(), SetMin(), SetMax(), SetFormat(), SetTitle() and Destroy()."
})
...
RowTab:Label({
    Title = "<b>Row</b> - Complete Layout Test"
})


RowTab:Paragraph({
    Title = "Equal Width",
    Text = "The following elements are intentionally placed in the same Row to verify equal cell sizing."
})
