...
RowTab:Label({
    Title = "<b>AutoFill Row</b> - Mega Layout Test",
})

RowTab:Paragraph({
    Title = "Row System",
    Text = "Tests the AutoFill Row layout using mixed elements, nested Rows, Sections, fonts, themes, element methods, dynamic Dropdowns, animated Sections, and stress-test layouts.",
})
...
RowTab:Paragraph({
    Title = "Titleless elements",
    Text = "Slider, Dropdown and TextBox should correctly use their full Row slot without reserving a title area.",
})

local NoTitleRow = RowTab:Row()
...
--==============================================================
-- 12. NESTED ROW INSIDE SECTION
--==============================================================

separator(
    RowTab,
    "Nested Row Inside Section"
)
...
--==============================================================
-- 14. SECTION ANIMATION TEST
--==============================================================

separator(
    RowTab,
    "Section Push / Pull Animation"
)

local AnimationRow =
    RowTab:Row()

local AnimatedSection =
    AnimationRow:Section({
        Title = "Animated Section",
        Open = false,
    })

AnimatedSection:Button({
    Title = "Inside A",
})
...
RowTab:Button({
    Title = "Section:Close()",
    Callback = function()
        AnimatedSection:Close()
    end,
})

--==============================================================
-- 15. DROPDOWN PUSH / PULL ANIMATION
--==============================================================

separator(
    RowTab,
    "Dropdown Push / Pull Animation"
)

local DropdownAnimationRow =
    RowTab:Row()

local AnimatedDropdown =
    DropdownAnimationRow:Dropdown({
        Title = "Options",
        Value = {
            "One",
            "Two",
...
RowTab:Button({
    Title = "Dropdown:SetOpen(false)",
    Callback = function()
        AnimatedDropdown:SetOpen(false)
    end,
})

--==============================================================
-- 16. MULTI-ROW SECTION + DROPDOWN
--==============================================================

separator(
    RowTab,
    "Complex Dynamic Layout"
)

local DynamicSection =
    RowTab:Section({
...
RowTab:Button({
    Title = "Open Dynamic Dropdown",
    Callback = function()
        DynamicDropdown:SetOpen(true)
    end,
})

RowTab:Button({
    Title = "Close Dynamic Dropdown",
    Callback = function()
        DynamicDropdown:SetOpen(false)
    end,
})
...
local function updateCompositionColor()
    ...
    if not CR
        or not CG
        or not CB
        or not CompositionPreview then
...
SecondTab:Label({
    Title =
        "Mister bis<br>" ..
        "Riss<br>" ..
        "Mister bis yest riss<br>" ..
        "Posmotri vniz tam<br>" ..
        "Mister bis karatist<br>" ..
        "Mister bis yurist<br>" ..
        "Mister bis gitarist",
})
...
FinalTab:Label({
    Title =
        "<font color=\"#55AAFF\" size=\"18\"><b>Final Integration Test</b></font>",
})
...
FinalTab:Paragraph({
    ...
    Text =
        "This final tab tests all supported elements and layout combinations: standalone elements, elements inside Sections, elements inside Rows, Rows inside Sections, Sections inside Rows, nested Sections, nested Rows, dynamic Dropdowns, animated Sections, Image, Console, RGB composition, font propagation, theme propagation and destruction.",
})
...
FinalTab:Paragraph({
    Title = "Standalone Paragraph",
    Text =
        "This paragraph tests the normal full-width text layout outside Row and Section.",
})
...
FinalTab:TextBox({
    Title = "Standalone TextBox",
    Placeholder = "Enter text...",
})


FinalTab:TextInput({
    Placeholder = "Standalone TextInput...",
})
...
StandaloneConsole:Log(
    "Standalone Console initialized."
)
...
StandaloneConsole:Log(
    "All required Console properties are configured."
)


--==============================================================
-- 02. SECTION - ALL ELEMENTS
--==============================================================
...
BasicSection:Label({
    Title = "Label inside Section",
})


BasicSection:Paragraph({
    Title = "Paragraph inside Section",
    Text =
        "This paragraph tests normal Section content and vertical spacing.",
})
...
BasicSection:TextBox({
    Title = "Section TextBox",
    Placeholder = "Section input...",
})


BasicSection:TextInput({
    Placeholder = "Section TextInput...",
})
...
local SectionConsole =
    BasicSection:Console({
        Size = UDim2.new(
            1,
            -12,
            0,
...
SectionConsole:Log(
    "Image and Console are both active."
)


--==============================================================
-- 03. ALL COMPACT ELEMENTS INSIDE ROW
--==============================================================

separator(
    FinalTab,
    "03. Elements Inside Row"
)


local AllElementsRow =
    FinalTab:Row()


AllElementsRow:Button({
    Title = "Button",
})


AllElementsRow:Toggle({
    Title = "Toggle",
})


AllElementsRow:Slider({
    Min = 0,
    Max = 100,
    Value = 50,
    Format = "{value}%",
...
AllElementsRow:TextBox({
    Placeholder = "TextBox",
})


AllElementsRow:Color({
    Title = "Color",
    Color = Color3.fromRGB(
        70,
        150,
...
local MediaIntegrationRow =
    FinalTab:Row()


MediaIntegrationRow:Image({
    Image = FINAL_IMAGE,
    Ratio = 1,
})
...
RowConsole:Log(
    "Testing RowElementContainer."
)

RowConsole:Log(
    "Image and Console share one Row."
)


--==============================================================
-- 05. ALL ELEMENTS INSIDE SECTION + ROW
--==============================================================

separator(
    FinalTab,
    "05. Section + Row Integration"
)


local SectionRowContainer =
    FinalTab:Section({
        Title = "Row Element Integration",
        Open = true,
    })


local SectionRow1 =
    SectionRowContainer:Row()
...
local SectionInsideRow =
    FinalTab:Row()


SectionInsideRow:Button({
    Title = "Before Section",
})


local SmallRowSection =
    SectionInsideRow:Section({
        Title = "Section In Row",
        Open = true,
    })


SmallRowSection:Button({
    Title = "Inside Button",
})


SmallRowSection:Toggle({
    Title = "Inside Toggle",
})


SmallRowSection:Slider({
    Title = "Inside Slider",
    Min = 0,
    Max = 100,
    Value = 35,
...
local DynamicSectionRow =
    FinalTab:Row()


local DynamicSection =
    DynamicSectionRow:Section({
...
DynamicSectionRow:Button({
    Title = "Outside Section",
})


--==============================================================
-- 08. MULTIPLE ROWS INSIDE SECTION
--==============================================================
...
GrandChildSection:TextBox({
    Placeholder = "Deep input",
})


GrandChildSection:Color({
    Title = "Deep Color",
    Color = Color3.fromRGB(
        180,
        80,
...
local DynamicDropdownRow =
    FinalTab:Row()


local DynamicDropdown =
    DynamicDropdownRow:Dropdown({
        Title = "Dynamic",
        Value = {
            "One",
            "Two",
...
local function UpdateFinalRGB()

    if not FinalR
        or not FinalG
        or not FinalB
        or not FinalColor then
...
FinalFontRow:TextBox({
    Placeholder = "Input",
})


FinalTab:Button({
    Title = "Font: RobotoMono",
    Callback = function()

        FinalFontRow:SetFont(
            Enum.Font.RobotoMono
        )
    end,
})
...
local FinalThemeRow =
    FinalThemeSection:Row()


FinalThemeRow:Button({
    Title = "Button",
})


FinalThemeRow:Toggle({
    Title = "Toggle",
})


FinalThemeRow:Slider({
    Min = 0,
    Max = 100,
    Value = 50,
})
...
FinalTab:Button({
    Title = "Update Current Theme",
    Callback = function()

        FinalThemeRow:UpdateTheme(
            Window.ThemeData
        )
    end,
})
...
--==============================================================
-- 19. FINAL REALISTIC COMPOSITION
--==============================================================

separator(
    FinalTab,
    "19. Final Realistic UI"
)


local RealisticSection =
    FinalTab:Section({
...
--==============================================================
-- 20. FINAL CONSOLE STRESS TEST
--==============================================================

separator(
    FinalTab,
    "20. Console Stress Test"
)
